...
def _recursive_image_find(self, tree, return_list=None, path=""):
    ...
    for item in children:
        ...
        if has_sub_children:
            ...
            try:
                print(item.findall("./Data/Image/ImageDescription/Dimensions/DimensionDescription"))
                dim_t = np.prod(
                    [
                        int(p.attrib["NumberOfElements"])
                        for p in item.findall("./Data/Image/ImageDescription/Dimensions/DimensionDescription")
            ...
            dim_x = int(
                item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="1"]').attrib[
                    "NumberOfElements"
                ]
            )
            dim_y = int(
                item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="2"]').attrib[
                    "NumberOfElements"
                ]
            )
            ...
            try:
                dim_z = int(
                    item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="3"]').attrib[
                        "NumberOfElements"
                    ]
                )
            except AttributeError:
            ...
            try:
                len_x = item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="1"]').attrib[
                    "Length"
                ]  # Returns len in meters
                scale_x = (int(dim_x) - 1) / (float(len_x) * 10**6)
            except (AttributeError, ZeroDivisionError):
                scale_x = None

            try:
                len_y = item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="2"]').attrib[
                    "Length"
                ]  # Returns len in meters
            ...
            # Try to get z-dimension
            try:
                len_z = item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="3"]').attrib[
                    "Length"
                ]  # Returns len in meters
            ...
            try:
                len_t = item.find('./Data/Image/ImageDescription/Dimensions/DimensionDescription[@DimID="4"]').attrib[
                    "Length"
                ]  # Returns len in meters
