...
class DeformationDetector(PipelineModule):
            ...
            with CheckAbleGroup(self, "find deformations (piv)").addToLayout() as self.group:
                with QtShortCuts.QVBoxLayout() as layout:
                    with QtShortCuts.QVBoxLayout() as layout2:
                        self.window_size = QtShortCuts.QInputNumber(
                            layout2,
                            "window size",
                            50,
                            float=False,
                        ...
                        self.overlap = QtShortCuts.QInputNumber(
                            layout2,
                            "overlap",
                            50,
                            float=False,
                        ...
                        with QtShortCuts.QHBoxLayout(None):
                            self.n_min = QtShortCuts.QInputString(
                                None,
                                "n_min",
                                "None",
                                allow_none=True,
                            ...
                            self.n_max = QtShortCuts.QInputString(
                                None,
                                "n_max",
                                "None",
                                allow_none=True,
                        ...
                        self.thresh_segmentation = QtShortCuts.QInputNumber(
                            None,
                        ...
                        self.continuous_segmentation = QtShortCuts.QInputBool(
                            None,
            ...
            with QtShortCuts.QVBoxLayout() as layout:
                ...
                with QtShortCuts.QHBoxLayout() as layout0:
                    ...
                    self.scale_max = QtShortCuts.QInputString(
                        None,
                        "",
                        10,  # if self.is_force_plot else 10,
                        type=float,
    ...
    def update_display(self, *, plotter=None):
        ...
        self.color1.setScale(
            0,
            disp_params["scale_max"] if disp_params else None,
            self.colormap_chooser.value(),
        )
