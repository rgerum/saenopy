...
class DeformationDetector(PipelineModule):
            ...
            with CheckAbleGroup(self, "find orientations").addToLayout() as self.group:
                with QtShortCuts.QVBoxLayout() as layout:
                    with QtShortCuts.QHBoxLayout():
                        self.sigma_tensor = QtShortCuts.QInputString(
                            None,
                            "sigma_tensor",
                            "7.0",
                            type=float,
                        ...
                        self.sigma_tensor_type = QtShortCuts.QInputChoice(
                            None,
                            "",
                            "µm",
                            ["µm", "pixel"],
                        ...
                        self.sigma_tensor_button = QtShortCuts.QPushButton(
                            None, "detect", self.sigma_tensor_button_clicked
                        )
                        self.sigma_tensor_button.setDisabled(True)
                    with QtShortCuts.QHBoxLayout():
                        self.edge = QtShortCuts.QInputString(
                            None,
                            "edge",
                            "40",
                            type=int,
                        ...
                        self.max_dist = QtShortCuts.QInputString(
                            None,
                            "max_dist",
                            "None",
                            type=int,
                    ...
                    self.ignore_cell = QtShortCuts.QInputBool(
                        None,
                        "ignore_cell_outline",
                        False,
                        settings=self.settings,
                    ...
                    with QtShortCuts.QHBoxLayout():
                        self.sigma_first_blur = QtShortCuts.QInputString(
                            None,
                            "sigma_first_blur",
                            "0.5",
                            type=float,
                        ...
                        QtWidgets.QLabel("px").addToLayout()
                    with QtShortCuts.QHBoxLayout():
                        self.angle_sections = QtShortCuts.QInputString(
                            None,
                            "angle_sections",
                            "5",
                            type=int,
                    ...
                    with QtShortCuts.QHBoxLayout():
                        self.shell_width = QtShortCuts.QInputString(
                            None,
                            "shell_width",
                            "5",
                            type=float,
                        ...
                        self.shell_width_type = QtShortCuts.QInputChoice(
                            None,
                            "",
                            "µm",
                            ["µm", "pixel"],
    ...
    def process(
        ...
        orientation_parameters: OrientationParametersDict,
    ):
        ...
        (
            ...
            excel_angles,
            excel_distance,
        ) = StuctureAnalysisMain(
            fiber_list=[result.get_absolute_path_fiber()],
    ...
    def sigma_tensor_button_clicked(self):
        ...
        class SigmaRange(QtWidgets.QDialog):
            def __init__(self, parent):
                ...
                with QtShortCuts.QVBoxLayout(self) as layout:
                    self.output_folder = QtShortCuts.QInputFolder(
                        None,
                        "output folder",
                        settings=settings,
                    ...
                    with QtShortCuts.QHBoxLayout() as layout2:
                        self.sigma_tensor_min = QtShortCuts.QInputString(
                            None,
                            "min",
                            "1.0",
                            type=float,
                        ...
                        self.sigma_tensor_max = QtShortCuts.QInputString(
                            None,
                            "max",
                            "15",
                            type=float,
                        ...
                        self.sigma_tensor_step = QtShortCuts.QInputString(
                            None,
                            "step",
                            "1",
                            type=float,
            ...
            def run(self):
                ...
                sigma_list = np.arange(
                    sigma_tensor_min,
                    sigma_tensor_max + sigma_tensor_step,
                    sigma_tensor_step,
                )
                ...
                for index, sigma in enumerate(sigma_list):
                    ...
                    app.processEvents()
                    # Create outputfolder
                    output_sub = os.path.join(
                        output_folder,
                        rf"Sigma{str(sigma * parent.scale.value()).zfill(3)}",
                    )  # subpath to store results
                    fiber_list, cell_list, out_list = generate_lists(fiber, cell, output_main=output_sub)
                    ...
                    StuctureAnalysisMain(
                        ...
                        segmention_thres=parent.segmention_thres.value()
                        if attr["segmention_thres"] is None
                        else attr["segmention_thres"],
                        seg_gaus1=parent.seg_gaus1.value() if attr["seg_gaus1"] is None else attr["seg_gaus1"],
                        seg_gaus2=parent.seg_gaus2.value() if attr["seg_gaus2"] is None else attr["seg_gaus2"],
