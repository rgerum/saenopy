...
def load_example(name, target_folder=None, progress_callback=None, evaluated=False):
    ...
    for ex in [
        get_examples,
        get_examples_2D,
        get_examples_spheroid,
        get_examples_orientation,
    ]:
        examples = ex()
        if name in examples:
...
def get_examples():
    ...
    return {
        "ClassicSingleCellTFM": {
            ...
            "reference_stack": example_path
            / "1_ClassicSingleCellTFM/Relaxed/Mark_and_Find_001/Pos*_S001_z{z}_ch{c:00}.tif",
            ...
            "url_evaluated_file": [
                "Pos004_S001_z{z}_ch{c00}_eval.saenopy",
                "Pos007_S001_z{z}_ch{c00}_eval.saenopy",
                "Pos008_S001_z{z}_ch{c00}_eval.saenopy",
            ],
        },
...
def get_examples_2D():
    ...
    return {
        "WTKO": {
            ...
            "url_evaluated_file": [
                "KO/04_bf_before_eval.saenopy2D",
                "KO/05_bf_before_eval.saenopy2D",
                "WT/03_bf_before_eval.saenopy2D",
                "WT/10_bf_before_eval.saenopy2D",
            ],
        },
    }
...
def get_examples_spheroid():
    ...
    return {
        "MCF7 spheroid": {
            ...
            "time_delta": 300,
            "input": example_path
            / "Jointforces_MCF7-time-lapse/20160912-122130_Mic3_rep?_pos*_x0_y0_modeBF_zMinProj.tif",
        ...
        "Human fibroblast spheroids": {
            ...
            "time_delta": 600,
            "input": example_path
            / "Jointforces_FibroblastSpheroids_RockInhibition/*/*Mic5_rep?_pos*_in-focus_modeBF_slice0_z0.tif",
            ...
            "url_evaluated_file": [
                "Control/20201021-180200_Mic5_rep{t}_pos09_in-focus_modeBF_slice0_z0_eval.saenopySpheroid",
        ...
        "Mouse organoids": {
            ...
            "time_delta": 3600,
            "input": example_path
            / "Jointforces_MouseOrganoids_MechanoAgonist/Mic5_rep?_pos*_in-focus_modeBF_slice0_z0.tiff",
            ...
            "url_evaluated_file": [
                "Mic5_rep{t}_pos42_in-focus_modeBF_slice0_z0_eval.saenopySpheroid",
