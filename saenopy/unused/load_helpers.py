...
from saenopy.multigrid_helper import make_box_mesh_coords, make_box_mesh_tets, set_active_fields
...
def make_box_mesh(mesh, CFG):
    ...
    print("coords")
    mesh.set_nodes(make_box_mesh_coords(dx, nx, rin, mulout))
    print("tets")
