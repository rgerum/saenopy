...
try:
    ...
    sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "saenopy"))
    import saenopy

    current_version = saenopy.__version__
    ...
    # the command
    command_string = "twine upload dist/saenopy-%s.tar.gz" % current_version
