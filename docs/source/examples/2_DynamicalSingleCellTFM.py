...
"""
# sphinx_gallery_thumbnail_path = '../../saenopy/img/examples/Dynamic_icon.png'
...
#
# Saenopy uses 3D particle image velocimetry (PIV) to calculate the
# matrix deformations in the collagen that are generated by the natural killer 
# cell at different times. For this we apply the followng parameters.
#
# +------------------+-------+
# | Piv Parameter    | Value |
# +==================+=======+
