...
=======================
This example calculates matrix deformations around a Human Umbilical Vein Endothelial Cells (HUVECs) that invades in a polyethylene glycol 841
(PEG) hydrogel cell between a relaxed and deformed stacks as measured and described in `[Jorge Barrasa-Fano et al., 2021] <https://www.sciencedirect.com/science/article/pii/S2352711021000625>`_.                                                
The data is available from the authors website here `here <https://www.mech.kuleuven.be/en/bme/research/mechbio/lab/tfmlab>`_.

"""

import saenopy

# sphinx_gallery_thumbnail_path = '../../saenopy/img/examples/Bead_example.png'
...
results = saenopy.get_stacks( 
    'TestDataTFMlabKULeuven\Stressed_z{z}_ch{c:00}.tif',
    reference_stack='TestDataTFMlabKULeuven\Relaxed_z{z}_ch{c:00}.tif',
