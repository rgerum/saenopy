...
# define the coordinates of the vertices of the mesh
...
# define if the vertices are "variable", e.g. allowed to be moved by the solver
# a boolean matrix with shape N_v
#                   0      1      2      3      4      5      6      7
var = np.array([ True,  True, False, False,  True, False, False,  True])

# the initial displacements of the vertices
# if the vertex is fixed (e.g. not variable) than this displacement will be fixed
# during the solving
U = np.array([[ 0.  ,  0.  ,  0.  ],  # 0
              [ 0.  ,  0.  ,  0.  ],  # 1
              [-0.25,  0.  ,  0.  ],  # 2
...
# relax the mesh and move the "varible" vertices
M.relax()

# store the forces of the vertices
M.storeF("F.dat")
